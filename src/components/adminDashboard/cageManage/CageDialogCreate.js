                                        ...
                                        <div class="col-span-full">
                                            ...
                                            <div class="mt-2">
                                                <input value={newCage.name}
                                                    ...
                                                    id="name"
                                                    type='text'
                                                    name="name" autocomplete="Name" class="block p-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="p-2 w-full">
                                        ...
                                        <div class="col-span-full">
                                            ...
                                            <div class="mt-2">
                                                <textarea value={newCage.description}
                                                    onChange={handleChange}
                                                    id="description"
                                                    name="description" rows="3" class="block p-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                                            </div>
