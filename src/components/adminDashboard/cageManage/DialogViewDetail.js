...
export default function DialogViewDetail({ open, onClose, selectedData }) {
                ...
                <div className="mx-auto max-w-2xl py-0 mb-3 pb-0 sm:py-0 lg:max-w-none lg:py-0">
                  <div>
                    <div className="relative h-full w-full overflow-hidden rounded-lg bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-64">
                      <img src={selectedData && selectedData.imagePath} alt='Main image' className="h-full w-full object-contain object-center" />
                    </div>
                  </div>
                  {imgCage.length > 0 && (
                    <h2 className="text-2xl font-bold text-gray-900 mb-2 mt-4">Extra images</h2>
                  )}
  ...
  `}
                  >
                    {imgCage.map((image, index) => (
                      <div className="group relative" key={index}>
                        <div className="relative h-40 w-full overflow-hidden rounded-lg bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-32">
                          <img src={image} alt={`Image ${index}`} className="h-full w-full object-contain object-center mx-auto" />
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="flex flex-wrap lg:w-4/5 mt-0 sm:mx-auto sm:mb-2 -mx-2">
            ...
            <button className="flex mx-auto mt-8 mb-0 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" onClick={onClose}>Close</button>
          </div>
        </section>
